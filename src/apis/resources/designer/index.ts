...
export const updateDesignerWorkspace = async (
  ...
  const res = await CustomerAPI.put<UpdateDesignerWorkspaceResponse>(
...
export const createDesignerWorkspace = async (
  ...
  const res = await CustomerAPI.post<CreateDesignerWorkspaceResponse>(
    `/v1/users/${userId}/shop`,
    data,
  );
  return res.data;
...
export const getDesignerProfile = async (
  userId: number,
): Promise<GetDesignerProfileResponse> => {
  const res = await CustomerAPI.get<GetDesignerProfileResponse>(
...
export const updateDesignerProfile = async (
  userId: number,
  data: UpdateDesignerProfileRequest,
): Promise<UpdateDesignerProfileResponse> => {
  const res = await CustomerAPI.put<UpdateDesignerProfileResponse>(
    `/v1/users/${userId}/profile`,
    data,
  );
  return res.data;
...
export const checkDesignerNicknameDuplicatedResponse = async (query: {
  ...
  const res = await CustomerAPI.get<CheckDesignerNicknameDuplicatedResponse>(
    `/v1/users/check`,
    { params: query },
  );
  return res.data;
