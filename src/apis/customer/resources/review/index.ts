...
export const getReviewDetail = async (userId: number, puppyId: number, processId: number, threadId: number, reviewId: number): Promise<GetReviewDetailResponse> => {
...
export const updateReview = async (userId: number, puppyId: number, processId: number, threadId: number, reviewId: number, data: UpdateReviewRequest): Promise<UpdateReviewResponse> => {
...
export const deleteReview = async (userId: number, puppyId: number, processId: number, threadId: number, reviewId: number): Promise<DeleteReviewResponse> => {
...
export const registerReview = async (userId: number, puppyId: number, processId: number, threadId: number, data: RegisterReviewRequest): Promise<RegisterReviewResponse> => {
...
export const getDesignerReviews = async (designerId: number): Promise<GetDesignerReviewsResponse> => {
  const res = await CustomerAPI.get<GetDesignerReviewsResponse>(`/v1/users/${designerId}/shop/reviews`);
  return res.data;
};
